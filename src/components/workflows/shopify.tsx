...
export default function ShopifyWebhookFlow() {
  ...
  return (
    <Card className="w-full max-w-md mx-auto mt-10 bg-linear-to-b from-green-900 to-gray-800 text-white rounded-2xl shadow-lg p-8">
      <CardHeader>
        <CardTitle className="text-2xl text-center font-semibold">
          Shopify Order Webhook Workflow
        </CardTitle>
      </CardHeader>
          ...
          <div key={i} className="relative flex flex-col items-center">
            {i !== 0 && (
              <motion.div
                ...
                animate={{ borderColor: stage === i ? "#34D399" : "#374151" }}
            ...
            <motion.div
              ...
              animate={{
                ...
                boxShadow:
                  stage === i ? "0px 0px 12px rgba(52, 211, 153, 0.6)" : "none",
              }}
              transition={{ duration: 0.4 }}
            ...
            {i < stages.length - 1 && (
              <motion.div
                className="absolute top-18 w-3 h-3 rounded-full bg-emerald-400"
                initial={{ opacity: 0 }}
